...
export default function RegisterForm({ onSuccess }: { onSuccess?: (msg: string) => void }) {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        // Server should send verification email and return success message
    ...
    function handleGoogleSignup() {
        // Explain implications of linking Google account on signup
        ...
        if (!confirmed) return;
        // signIn will redirect by default (NextAuth). Use callbackUrl to send them to dashboard or to a post-signup page.
